$(document).ready(function() {
  console.log('page case-type loaded');
  if (getUrlParam('series') == 2) {
    $('#js-banner').css({ background: '../img/case-type/banner.png' });
    $('#js-title-en').html('Business creators');
    $('#js-title-cn').html('商业创造家，用品质塑造经典之家');
  }

  // const rippleSettings = {
  //   maxSize: 507,
  //   animationSpeed: 3,
  //   strokeColor: [174, 88, 195],
  // };
  ...
  // const height = $('.banner-container').height();
  // const width = $('.banner-container').width();
  ...
  //   var ay = ($(window).innerHeight() / 2 - (e.pageY - $(document).scrollTop())) / 30;
  //   console.log(ax, ay, $(window).innerHeight() / 2, e.pageY, $(document).scrollTop(), e.pageY - $(document).scrollTop())
