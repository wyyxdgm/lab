...
module.exports.toH5 = (srcPath, distPath, colorAliasMap) => {
  fs.readFile(srcPath, function(err, scss) {
    ...
    result = result.replace(/(fs)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(w)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(h)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(ptb)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(plr)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(mtb)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(mlr)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(ml)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(mt)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(mr)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(mb)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(pl)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(pt)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(pr)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(pb)\((\-?\w+px)\)/g, '$1_($2)');
    result = result.replace(/(wh)\((\-?\w+px)\)/g, '$1_($2)');
